...
public class AccountDetailsPage extends javax.swing.JDialog {
    ...
    public AccountDetailsPage(java.awt.Frame parent, boolean modal, Customer customer) {
        ...
        oibField.setText(customer.getOib());
        ...
        balanceField.setText(String.format("%.2f",(customer.geAccount().getBalance())));
        interestField.setText(String.valueOf(customer.getAccount().getInterest() * 100) +  "%");
        feeField.setText(String.format("%.2f", (customer.geAccount().getTransactionFee())));
    ...
    private void initComponents() {
        ...
        oibField = new javax.swing.JLabel();
    ...
    private javax.swing.JLabel oibField;
